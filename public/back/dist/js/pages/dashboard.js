$(function(){'use strict'
$('.connectedSortable').sortable({placeholder:'sort-highlight',connectWith:'.connectedSortable',handle:'.card-header, .nav-tabs',forcePlaceholderSize:!0,zIndex:999999})
$('.connectedSortable .card-header').css('cursor','move')
$('.todo-list').sortable({placeholder:'sort-highlight',handle:'.handle',forcePlaceholderSize:!0,zIndex:999999})
$('.textarea').summernote()
...
$('#calendar').datetimepicker({format:'L',inline:!0})
...
var pieOptions={legend:{display:!1},maintainAspectRatio:!1,responsive:!0}
var pieChart=new Chart(pieChartCanvas,{type:'doughnut',data:pieData,options:pieOptions})
var salesGraphChartCanvas=$('#line-chart').get(0).getContext('2d')
var salesGraphChartData={labels:['2011 Q1','2011 Q2','2011 Q3','2011 Q4','2012 Q1','2012 Q2','2012 Q3','2012 Q4','2013 Q1','2013 Q2'],datasets:[{label:'Digital Goods',fill:!1,borderWidth:2,lineTension:0,spanGaps:!0,borderColor:'#efefef',pointRadius:3,pointHoverRadius:7,pointColor:'#efefef',pointBackgroundColor:'#efefef',data:[2666,2778,4912,3767,6810,5670,4820,15073,10687,8432]}]}
var salesGraphChartOptions={maintainAspectRatio:!1,responsive:!0,legend:{display:!1},scales:{xAxes:[{ticks:{fontColor:'#efefef'},gridLines:{display:!1,color:'#efefef',drawBorder:!1}}],yAxes:[{ticks:{stepSize:5000,fontColor:'#efefef'},gridLines:{display:!0,color:'#efefef',drawBorder:!1}}]}}
